...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p25-s02")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p25-s02";
...
export default function P25S02MapProviderUnavailable({ mapKey = "evz.map.provider" }) {
  useEvzStyles();
