...
export default function P05S01HoldSelect({ nextPath = "/booking/pay" }) {
  useEvzStyles();
    ...
    <EvzScreen>
      ...
      <footer className="evz-footer">
        <div className="evz-footer-actions">
          <a
            href={station ? nextPath : "#"}
            onClick={handleContinue}
            aria-disabled={!station}
            className={
          ...
          <a href="/stations/map-list" className="evz-button evz-button--secondary">
            Change station
          </a>
        </div>
      </footer>
