...
export default function StationMapList({ nextPath = "/stations/details" }) {
  useEvzStyles();
  ...
  const nextHref = canContinue
    ? `${nextPath}?stationId=${encodeURIComponent(selected.id)}`
    : "#";
  ...
  return (
    <EvzScreen>
      ...
      <footer className="evz-footer">
        ...
        <a href="/providers/select" className="evz-text-link">
          Change provider
        </a>
      </footer>
    </EvzScreen>
