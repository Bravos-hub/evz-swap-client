...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p29-s03")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p29-s03";
...
export default function P29S03ProviderPlans({ nextPath = "/providers/plans" }) {
  useEvzStyles();
