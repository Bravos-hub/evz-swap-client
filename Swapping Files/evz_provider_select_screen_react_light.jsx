...
export default function ProviderSelect({ nextPath = "/stations/map-list" }) {
  useEvzStyles();
  ...
  const nextHref = useMemo(() => {
    if (!selected) return "#";
    return `${nextPath}?provider=${encodeURIComponent(selected)}`;
  }, [selected, nextPath]);
  ...
  return (
    <EvzScreen>
      ...
      <footer className="evz-footer">
        ...
        <a href="/vehicles/select" className="evz-text-link">
          Back to vehicles
        </a>
      </footer>
    </EvzScreen>
