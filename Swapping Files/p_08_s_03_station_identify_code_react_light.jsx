...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p08-s03")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p08-s03";
...
export default function P08S03StationIdentifyCode({ nextPath = "/swap/self/locker" }) {
  useEvzStyles();
