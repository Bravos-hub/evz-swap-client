...
function useEvzStyles() {
  useEffect(() => {
    if (document.getElementById("evz-mobile-styles-p07-s01")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p07-s01";
...
export default function P07S01ArrivedShowQR({ backPath = "/booking/confirmed", payPath = "/swap/operator/pay" }) {
  useEvzStyles();
