...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p29-s01")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p29-s01";
...
export default function P29S01Promotions({ nextPath = "/wallet/transactions" }) {
  useEvzStyles();
