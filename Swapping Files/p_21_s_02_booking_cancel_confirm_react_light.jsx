...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p21-s02")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p21-s02";
...
export default function P21S02BookingCancelConfirm({ afterHref = "/stations/map-list" }) {
  useEvzStyles();
      ...
      <footer className="evz-footer">
        <div className="evz-footer-row">
          <button
            ...
            onClick={() => goTo("/booking/confirmed")}
          >
            Keep booking
          </button>
          <button
