...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p25-s01")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p25-s01";
...
export default function P25S01GpsDisabled({ nextPath = "/stations/search" }) {
  useEvzStyles();
