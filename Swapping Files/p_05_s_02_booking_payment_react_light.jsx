...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p05-s02")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p05-s02";
...
export default function P05S02BookingPayment({ nextPath = "/booking/confirmed" }) {
  useEvzStyles();
  ...
  // Follow original behavior: we rely on localStorage for context
  // and navigate using nextPath.
  const nextHref = useMemo(() => `${nextPath}`, [nextPath]);
