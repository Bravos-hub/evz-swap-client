...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p11-s03")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p11-s03";
...
export default function P11S03RateExperience({ donePath = "/vehicles/select" }) {
  useEvzStyles();
