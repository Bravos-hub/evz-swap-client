...
function useEvzExtendPayStyles() {
  useEffect(() => {
    if (typeof document === "undefined") return;
    if (document.getElementById("evz-extend-pay-styles")) return;
    const style = document.createElement("style");
    style.id = "evz-extend-pay-styles";
...
function getBookingItem(key: string, fallback = "0") {
...
export default function P06S02ExtendPayment() {
  ...
  const handleConfirm = () => {
    ...
    window.location.assign("/booking/extend/processing");
  };
