...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p11-s01")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p11-s01";
...
export default function P11S01ScanNewBattery({ nextPath = "/swap/self/done" }) {
  useEvzStyles();
