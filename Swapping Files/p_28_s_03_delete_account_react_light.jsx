...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p28-s03")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p28-s03";
...
export default function DeleteAccount({ afterHref = "/start/language" }) {
  useEvzStyles();
