...
function useEvzStyles() {
  useEffect(() => {
    ...
    if (document.getElementById("evz-mobile-styles-p08-s02")) return;
    const style = document.createElement("style");
    style.id = "evz-mobile-styles-p08-s02";
...
export default function P08S02StationIdentifyScan({ nextPath = "/swap/self/locker" }) {
  useEvzStyles();
