...
export default function TimeExtendedScreen(): JSX.Element {
      ...
      <main className="evz-content">
        <section className="evz-card">
          ...
          <div className="evz-actions-row">
            ...
            <button
              type="button"
              onClick={() => navigate(ROUTES.EXTEND_HOLD)}
              className="evz-chip-button"
              style={{ background: 'none', border: 'none', cursor: 'pointer' }}
            >
              Extend
            ...
            <button
              type="button"
              onClick={() => navigate(ROUTES.BOOKING_CANCEL)}
              className="evz-chip-button"
              style={{ background: 'none', border: 'none', cursor: 'pointer' }}
            >
              Cancel
          ...
          <button
            ...
            onClick={() => {
              const station = loadStation(getBookingItem("stationId"));
