...
function useEvzStyles(): void {
  useEffect(() => {
    ...
    const styleId = "evz-mobile-styles-p15-s02";
...
function Row({ label, value }: any): JSX.Element {
  return (
...
export default function SwapSessionDetailsScreen(): JSX.Element {
  useEvzStyles();
